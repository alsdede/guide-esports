    ...
    <div className="w-full flex justify-center">
      ...
      <div className="flex flex-col gap-4 w-full max-w-2xl lg:hidden">
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 right-4 z-20">
            <span className="text-white text-base font-semibold drop-shadow-lg">
              LTA Sul 2025: “Sei que foi ruim, mas estamos atrás da melhoria”, diz paiN TitaN em recado para a torcida
            </span>
          </div>
        </a>
      </div>
      {/* Desktop/laptop: grid com posts e transferências lado a lado */}
      <div className="hidden lg:grid grid-cols-[1fr_300px] md:gap-2 lg:gap-12 w-full max-w-7xl min-h-[400px]">
        <div className="grid grid-cols-2 grid-rows-2 gap-2 h-[400px]">
          <a
            href="/lta-sul-2025-eu-quero-mostrar-que-mereco-diz-lev-hauz/"
            className="relative rounded-xl overflow-hidden shadow-lg h-[400px] row-span-2 col-span-1 group bg-gradient-to-br from-slate-900/80 via-slate-800/70 to-gray-900/80 border border-white/10 backdrop-blur-md backdrop-saturate-150"
          >
            <Image
              src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80"
              alt="Imagem genérica esportes"
          ...
          <a
            href="/copa-do-mundo-r6-2025-w7m-e-nip-garantem-vaga-na-competicao/"
            className="relative rounded-xl overflow-hidden shadow-lg h-[190px] col-start-2 row-start-1 group bg-gradient-to-br from-slate-900/80 via-slate-800/70 to-gray-900/80 border border-white/10 backdrop-blur-md backdrop-saturate-150"
          >
            <Image
              src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80"
              alt="Copa do Mundo R6 2025: w7m e NiP garantem vaga na competição"
          ...
          <a
            href="/lta-sul-2025-sei-que-foi-ruim-mas-estamos-atras-da-melhoria-diz-pain-titan-em-recado-para-a-torcida/"
            className="relative rounded-xl overflow-hidden shadow-lg h-[190px] col-start-2 row-start-2 group bg-gradient-to-br from-slate-900/80 via-slate-800/70 to-gray-900/80 border border-white/10 backdrop-blur-md backdrop-saturate-150"
          >
            <Image
              src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80"
              alt="LTA Sul 2025: “Sei que foi ruim, mas estamos atrás da melhoria”, diz paiN TitaN em recado para a torcida"
